...
from french_tax_mcp.constants import (
    IMPOTS_BASE_URL as BASE_URL,
    IMPOTS_BRACKETS_URL as BRACKETS_URL,
    IMPOTS_FORMS_BASE_URL as FORMS_BASE_URL,
    IMPOTS_PINEL_URL as PINEL_URL,
    IMPOTS_LMNP_URL as LMNP_URL,
    TAX_BRACKETS,
    ERROR_MESSAGES,
    SUCCESS_MESSAGES
)
