...
class BusinessTaxAnalyzer:
    ...
    async def calculate_micro_enterprise_tax(
        ...
        logger.info(f"Calculating micro-enterprise tax for {annual_revenue}€ {activity_type} activity for year {tax_year}")
    ...
    async def calculate_auto_entrepreneur_tax(
        ...
        logger.info(f"Calculating auto-entrepreneur tax for {annual_revenue}€ {activity_type} activity for year {tax_year}")
        ...
        try:
            ...
            return {
                ...
                "data": {
                    ...
                    "total_tax": total_tax,
                    "net_income": net_income,
                    "declaration_info": self._get_auto_entrepreneur_declaration_info(activity_type, versement_liberatoire)
                },
...
async def calculate_micro_enterprise_tax(
    ...
    Returns:
        Dictionary containing tax calculation details
    """
    return await business_tax_analyzer.calculate_micro_enterprise_tax(annual_revenue, activity_type, accre_eligible, year)
...
async def calculate_auto_entrepreneur_tax(
    ...
    Returns:
        Dictionary containing tax calculation details
    """
    return await business_tax_analyzer.calculate_auto_entrepreneur_tax(annual_revenue, activity_type, versement_liberatoire, accre_eligible, year)
