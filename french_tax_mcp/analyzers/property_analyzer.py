...
class PropertyTaxAnalyzer:
    ...
    async def calculate_pinel_benefit(
        ...
        """
        logger.info(f"Calculating Pinel benefit for {property_price}€ property with {commitment_period} year commitment")
        ...
        try:
            ...
            return {
                ...
                "data": {
                    ...
                    "reduction_schedule": self._generate_reduction_schedule(annual_reduction, commitment_period, acquisition_date)
                },
            ...
            return {
                "status": "error",
                "message": f"Failed to calculate Pinel benefit: {str(e)}"
            }
    ...
    async def calculate_lmnp_benefit(
        ...
        try:
            ...
            return {
                "status": "error",
                "message": f"Failed to calculate LMNP benefit: {str(e)}"
            }
...
async def calculate_lmnp_benefit(
    ...
    Returns:
        Dictionary containing LMNP benefit calculation details
    """
    return await property_tax_analyzer.calculate_lmnp_benefit(annual_rent, expenses, property_value, furniture_value, regime)
