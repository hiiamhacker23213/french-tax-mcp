...
from french_tax_mcp.scrapers.impots_scraper import get_tax_brackets, get_form_info, get_scheme_details
from french_tax_mcp.scrapers.service_public_scraper import get_tax_procedure, get_tax_deadlines
from french_tax_mcp.scrapers.legal_scraper import get_tax_article, search_tax_law
from french_tax_mcp.analyzers.income_analyzer import calculate_income_tax, calculate_household_parts
from french_tax_mcp.analyzers.business_analyzer import calculate_micro_enterprise_tax, calculate_auto_entrepreneur_tax
...
async def get_tax_brackets_wrapper(
    ctx: Context,
    year: Optional[int] = None
) -> Optional[Dict]:
            ...
            return {
                ...
                'data': {
                    ...
                    'related_forms': [
                        ...
                        {'number': '2044-SPE', 'title': 'Déclaration des revenus fonciers spéciaux'}
                    ],
