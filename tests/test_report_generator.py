...
class TestReportGenerator:
    ...
    async def test_generate_tax_report_markdown(self):
        ...
        result = await generator.generate_tax_report({"test": "data"}, "Test Topic", None, "markdown")
        ...
        generator._generate_markdown_report.assert_called_once_with({"test": "data"}, "Test Topic", "base_report")
    ...
    async def test_generate_tax_report_csv(self):
        ...
        generator._generate_csv_report.assert_called_once_with({"test": "data"}, "Test Topic", "base_report")
    ...
    async def test_generate_tax_report_with_output_file(self, tmp_path):
        ...
        # Call generate_tax_report
        result = await generator.generate_tax_report({"test": "data"}, "Test Topic", str(output_file), "markdown")
    ...
    def test_determine_report_type(self):
        ...
        assert generator._determine_report_type({"calculation": "income_tax"}, "Income Tax Calculation") == "calculation_guide"
